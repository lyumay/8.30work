class upload{
  constructor(){
    ...
    this.filename="file";
    //选择按钮的样式
    this.selectBtnStyle="width:150px;height:50px;border-radius:5px;background:orange;line-height:50px;";
    //选择按钮的文本
    this.selectBtnCon="请选择";
    //上传按钮的样式
    this.upBtnStyle="width:150px;height:50px;border-radius:5px;background:#ccc;clear:both;line-height:50px;"
      //上传按钮的文本样式
    this.upBtnCon="点击上传";
        //预览区域的大小
